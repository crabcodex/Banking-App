...
export function UsersPage() {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h1 className="text-2xl font-bold text-text-primary">Usuarios Internos</h1>
      <p className="mt-2 text-sm text-text-secondary max-w-md">
        Gestion de ejecutivos, gerentes y personal bancario. Roles, permisos y accesos por sucursal.
      </p>
